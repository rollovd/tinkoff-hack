...
def start_command(message):
    ...
    text_info = f'Ты можешь воспользоваться любой из следующих команд:\n' \
                f'1) /game - команда предложит тебе сыграть в OlegGo;\n' \
                f'2) /saved_facts - команда покажет тебе список интересных финансовых фактов;\n' \
                f'3) /shop - команда позволит тебе немного пошопиться;\n' \
                f'4) /leaderboard - здесь ты можешь сравнить свои достижения с друзьями\n'
